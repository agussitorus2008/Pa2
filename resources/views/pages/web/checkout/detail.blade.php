                    ...
                    <form action="#">
                        ...
                        <div class="tab-content">
                            <div class="text-center py-5">
                                ...
                                <h3 class="fw-semibold">Order ID: <a href="javascript:;"
                                        class="text-decoration-underline">{{ $order->code }}</a></h3>
                            </div>
                        </div>
                        <!-- end tab content -->
                    </form>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-md bg-light rounded p-1">
                                                <img src="{{ asset('images/product/image/' . ($item->product->image ?? 'default-image.png')) }}"
                                        ...
                                        <td>
                                            @if ($item->product)
                                                <h5 class="fs-14"><a
                                                        href="{{ route('web.product.show', $item->product->id) }}"
                                        ...
                                        <td class="text-end">Rp.
                                            {{ number_format($item->product->price * 100) . ' x ' . $item->quantity }}
                                        </td>
                                    </tr>
                                @endforeach

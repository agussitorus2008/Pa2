                            ...
                            <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link fs-15 p-3 active" id="pills-bill-info-tab"
                                        ...
                                        role="tab" aria-controls="pills-bill-info" aria-selected="true"><i
                            ...
                            <div class="tab-pane fade show active" id="pills-bill-info" role="tabpanel"
                                ...
                                <div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nama" name="nama"
                                                    placeholder="Enter first name" value="{{ Auth::user()->nama }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="" name="alamat" placeholder="Enter address" rows="3">{{ Auth::user()->alamat }}</textarea>
                                    </div>
                                            ...
                                            <div data-bs-toggle="collapse"
                                                ...
                                                <div class="form-check card-radio">
                                                    ...
                                                    <label class="form-check-label" for="shippingMethod03">
                                                        ...
                                                        <span
                                                            class="text-muted fw-normal text-wrap d-block">080808080808</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="fs-14"><a href="apps-ecommerce-product-details.html"
                                                        class="text-dark">{{ $item->product->title }}</a>
                                                </h5>
                                                <span class="fw-semibold">Rp.
                                                    {{ number_format($item->product->price) . ' x ' . $item->quantity }}</span>
                                            </td>
                                            <td class="text-end">
                                                <span class="fw-semibold">Rp.
    ...
    @section('custom_js')
        <script>
            $(document).ready(function() {
                ...
                $('#cart-subtotal').html(subtotal.toLocaleString('id-ID', {
                    style: 'currency',
                    currency: 'IDR'
                }));

                var total_price = subtotal - 0;
                $('#all-total').html(total_price.toLocaleString('id-ID', {
                    style: 'currency',
                    currency: 'IDR'
                }));

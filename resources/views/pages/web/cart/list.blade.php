<div class="row mb-3" id="cart">
    <div class="col-xl-8">
        ...
        @foreach ($carts as $item)
            ...
            <div class="card data-product" data-price="{{ $item->product->price }}"
                        ...
                        <div class="col-sm-auto">
                            <div class="text-lg-end">
                                ...
                                <h5 class="fs-14"><span id="ticket_price" data-price="{{ $item->product->price }}"
                                        ...
                                        {{ number_format($item->product->price, 2, ',', '.') }}</span></h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="sticky-side-div">
            <div class="card">
                ...
                {{-- <div class="card">
                        <div class="card-body">
                          <div class="mb-3">
                            <label for="choices-publish-status-input" class="form-label">Pilih Pembayaran</label>

                            <select class="form-select" id="choices-publish-status-input" data-choices data-choices-search-false>
                              <option value="Scheduled">Cash</option>
                              <option value="Draft">Transfer</option>
                            </select>
                          </div>
                        </div>
                        <!-- end card body -->
...
<script>
    ...
    function get_cart() {
        ...
        $('#cart-subtotal').html(subtotal_price.toLocaleString('id-ID', {
            style: 'currency',
            currency: 'IDR'
        }));
